			  ...
			  <div class="container">
				 <div class="col-md-4 banner-grid" style="box-shadow: 5px 10px 8px #888888;">
					 ...
					 <div class="banner-grid-sec">
						 <div class="grid_info">
							 <div class="blg-pic">
								 <img src="../images/gallery/trip1.jpg" class="img-responsive" alt="">
							 </div>
							 <div class="blg-pic-info">
								 <h4><a href="gallery.php">Study Tour of Life Sciences</a></h4>
						 ...
						 <div class="grid_info" style="margin-top:5px;">
							 <div class="blg-pic">
								 <img src="../images/gallery/mtbc1.jpg" class="img-responsive" alt="">
							 </div>
							 <div class="blg-pic-info">
								 <h4><a href="gallery.php">Study tour of Computing Students</a></h4>
								 <p>Visit of Department of Computing students at MTBC, Bagh</p>
							 </div>
							 <div class="clearfix"></div>
						 </div>
						 <div class="more">
							 <a href="gallery.php">See more from the Blog ></a>
						 </div>
					 </div>
				 </div>
		 ...
		 <div class="welcm_sec">
			 ...
			 <div class="col-md-9 campus">
				 ...
				 <div class="col-md-4 wel_grid">
					 <img src="../images/departments/dept of computing and technology.jpg" class="img-responsive" alt=""/>
				 ...
				 <div class="col-md-4 wel_grid">
					 <img src="../images/departments/Dept of Engineering.jpg" class="img-responsive" alt=""/>
				 ...
				 <div class="col-md-4 wel_grid">
					 <img src="../images/departments/dept of graduate studies.jpg" class="img-responsive" alt=""/>
					...
					<div class="col-md-4 wel_grid">
						<img src="../images/departments/dept of life sciences.jpg" class="img-responsive" alt=""/>
				 ...
				 <div class="col-md-4 wel_grid">
					 <img src="../images/departments/dept of management science.jpg" class="img-responsive" alt=""/>
				 ...
				 <div class="col-md-4 wel_grid">
					 <img src="../images/departments/dept of pharmacy.jpg" class="img-responsive" alt=""/>
